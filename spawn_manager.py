...
# from metadrive.component.block.first_block import FirstPGBlock
...
class SpawnManager(BaseManager):
    ...
    def __init__(self):
        ...
        # print('target_init: ', target_vehicle_configs)
    ...
    def _randomize_position_in_slot(self, target_vehicle_config): # LHH: de-randomize the positions.
        ...
        vehicle_config["spawn_longitude"] += 0 # self.np_random.uniform(-long / 2, long / 2)
        vehicle_config["spawn_lateral"] += 0 # self.np_random.uniform(-lat / 2, lat / 2)
